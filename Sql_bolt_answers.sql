...
-- It had a rating of 8.7, and made 340 million domestically and 270 million internationally. Add the record to the  BoxOffice table. 
...
-- Create a new table named TestDatabases with the following columns:
